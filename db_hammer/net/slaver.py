        ...
        while True:
            ...
            try:
                ...
                if err_delay < max_err_delay:
                    ...
                    raise Exception("Slaver连接不上Master,重新请求Nat")
                continue
...
def run_slaver(communicate_addr, target_addr, secret_key, max_spare_count=5, ssl=False):
    ...
    if isinstance(target_addr, str):
        communicate_addr = (target_addr.split(":")[0], int(target_addr.split(":")[1]))
...
if __name__ == '__main__':
    run_slaver(communicate_addr="127.0.0.1:9999", target_addr="127.0.0.1:22", secret_key='abc123')
